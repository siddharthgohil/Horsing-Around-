<template>
  <line-chart class = "history_positions" width =500px :data="horsedata" xtitle="Race Number" ytitle="Position"></line-chart>
</template>
    ...
    data(){
        return{
            horsedata: [
                ...
                {name: 'horse3', data: {"R1": 3, "R2": 5, "R3": 4, "R4": 4, "R5": 0, "R6": 3}},
